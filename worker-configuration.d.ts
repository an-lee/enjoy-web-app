...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WORKERS_AI_TEXT_MODEL" | "WORKERS_AI_TTS_MODEL" | "AZURE_SPEECH_SUBSCRIPTION_KEY" | "AZURE_SPEECH_REGION" | "API_BASE_URL">> {}
}
